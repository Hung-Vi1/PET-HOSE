    ...
    <>
      {
        spTrongTrang.map((dhdv, i) => {
          ...
          if (dhdv.trang_thai === "cho_xac_nhan") {
            TrangThaiDonHang = (
              <span className="badge text-bg-secondary">Chờ xác nhận</span>
            );
          } else if (dhdv.trang_thai === "da_xac_nhan") {
            TrangThaiDonHang = (
              <span className="badge text-bg-info">Đã xác nhận</span>
            );
          } else if (dhdv.trang_thai === "dang_van_chuyen") {
            TrangThaiDonHang = (
              <span className="badge text-bg-warning">Đang vận chuyển</span>
            );
            ...
            TrangThaiDonHang = <span className="badge text-bg-danger">Đã hủy</span>;
          }
